...
class MyApp(App):
    ...
    def on_start(self):
        ...
        def draw_net(self, mode):
            ...
            for i in range(3):
                ...
                for j in range(3):
                    ...
                    if not(btn in self.all_btn_ids):
                        self.all_btn_ids.append(btn)
        ...
        def computer_player(self):
            chose_btn = ''
            btns_text = ['0-0', '0-2', '2-0', '2-2',
                         '0-1', '0-1', '1-2', '2-1', '1-1']
            available_btns_ids = [x for x in self.all_btn_ids if x.text in btns_text]
