...
class OptionTable(Popup):
    def __init__(self, mode, app, **kwargs):
        ...
        self.pos_hint = {'cemter_x': 0.5, "top": .7}
        self.height = 250
        self.width = 310
        self.auto_dismiss = False
        # Titel
        self.title = 'Wähle dein Symbol'.upper()
        ...
        self.x_btn.bind(on_release=lambda x: self.colorize('o'))
        self.save_btn.bind(on_release=lambda x: self.start_game())
        # Positionierung der Widgets im Popup
